...
class WebViewOverlayService1 : Service() {
    val debug = false
    private val serviceScope = CoroutineScope(Dispatchers.Main + SupervisorJob())

    companion object {
        const val NOTIFICATION_CHANNEL_ID = "webview_overlay_service_channel1"
        const val NOTIFICATION_ID = 67891
    ...
    private fun setupWebView(webView: WebView) {
        ...
        val initInnerScrollY = ParkingInfo.y1
        val initScrollX = 0
